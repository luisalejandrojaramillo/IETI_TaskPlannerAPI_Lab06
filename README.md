...
[Docker Hub](https://hub.docker.com/repository/docker/luisalejandroj/taskplanner)

[Punto 3; Repo de FrontEnd](https://github.com/luisalejandrojaramillo/IETI_TaskPlannerFrontEnd_Lab06)

## Prueba punto 3

* Estos datos los vamos a traer con nuestro servicio de Front End

![Azure](./img/2.PNG)

* Como podemos observar, podemos acceder a los datos correctamente
